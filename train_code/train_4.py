...
sub.to_csv((r"D:\a_zhy\MachineLearning\game\submit\submit_" + datetime.datetime.now().strftime('%Y%m%d_%H%M%S') + ".csv"), header=None,
...
print(df)
df.to_csv('catboost_feature_importance.csv',encoding='utf-8')
